...
const SignIn1 = () => {
 ...
 <div className="min-h-screen flex flex-col items-center justify-center bg-[#121212] relative overflow-hidden w-full rounded-xl">
      ...
      <div className="text-white  bg-slate-600 p-3 rounded-2xl flex flex-col gap-2">
        <p>Login Credentials</p>
        <p>email : <strong>arjun.sharma@example.com</strong></p>
         <p>password : <strong>Arjun@123</strong></p>
      </div>
