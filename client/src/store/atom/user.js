...
export const balanceAtom = atom({
    ...
    default: selector({
        ...
        get: async ({ get }) => {
            ...
            const response = await axios.get('https://localhost:5000/api/v1/account/balance', {
                headers: {
...
export const userDetailsSelector = selector({
    ...
    get: async ({ get }) => {
        ...
        const res = await axios.get(`https://paywallet-backend1.onrender.com/api/v1/user/bulk?filter=${user}`, {
            headers: {
